...
DEFAULT_MATCH_MODE = "pairwise"   
DEFAULT_IOU_THR = 0.5
DEFAULT_IGNORE_IOF_THR = 0.5  
...
class DetectionIoUEvaluator(object):
    ...
    def evaluate_image(self, gt, pred):
        ...
        def compute_ap(confList, matchList, numGtCare):
            ...
            return AP
        match_mode = getattr(self, "match_mode", "pairwise")  
        ...
        if len(gtPols) > 0 and len(detPols) > 0:
            ...
            if match_mode == "pairwise":
                ...
                per_gt_cover_thr = getattr(self, "per_gt_cover_thr", 0.5)  
                ...
                per_det_inside_gt_thr = getattr(self, "per_det_inside_gt_thr", 0.5)
                credit_all_dets_in_union = getattr(self, "credit_all_dets_in_union", True) 
                ...
                tp_gt   = int(gt_has.sum())  
                tp_det  = int(det_has.sum()) 
                tp_pair = len(pairs)          
                detMatched = tp_gt           
